#' @title Return the root path for the MNO simulation as \code{character}.
#' 
#' @description \code{getRootPath} returns the root path for the MNO simulation. 
#' 
#' It searches the path in the environment variable of the system called
#' "MNO_SIMULATION_PATH" and in the mno_simulation.ini file. 
